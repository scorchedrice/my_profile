    ...
    <div className="flex justify-center h-[140px] gap-8">
      <div className="flex flex-col items-center">
        <div className="w-[80px] h-[80px]">
          <svg fill="#3178C6" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-col items-center">
        <div className="w-[80px] h-[80px]">
          <svg fill="#F7DF1E" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-col items-center">
        <div className="w-[80px] h-[80px]">
          <svg fill="#0175C2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Dart</title>
            <path
